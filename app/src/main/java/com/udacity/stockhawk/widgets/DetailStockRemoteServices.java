...
public class DetailStockRemoteServices extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int i) {
                ...
                RemoteViews remoteViews = new RemoteViews(DetailStockRemoteServices.this.getPackageName(),
                ...
                if (PrefUtils.getDisplayMode(DetailStockRemoteServices.this)
                        .equals(DetailStockRemoteServices.this.getString(R.string.pref_display_mode_absolute_key))) {
